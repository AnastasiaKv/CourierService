package md5cf98ae5ad98dc2c42ef130027471014d;
		...
		android.support.v7.widget.RecyclerView.OnChildAttachStateChangeListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DesignLibrary.Helpers.AttachStateChangeListener, CourierService_MobileApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AttachStateChangeListener.class, __md_methods);
	}
	...
	public AttachStateChangeListener () throws java.lang.Throwable
	{
		...
		if (getClass () == AttachStateChangeListener.class)
			mono.android.TypeManager.Activate ("DesignLibrary.Helpers.AttachStateChangeListener, CourierService_MobileApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
