...
using CourierService_MobileApp.Helpers;
...
using CourierService_MobileApp.Resources.Helpers;

namespace CourierService_MobileApp.Fragments
{
    public class Fragment1 : SupportFragment
    {
        ...
        {
            var values = GetRandomSubList(Orders.OrdersStrings, 30);
        ...
        public class SimpleStringRecyclerViewAdapter : RecyclerView.Adapter
        {
            ...
            public SimpleStringRecyclerViewAdapter(Context context, List<string> items, Android.Content.Res.Resources res)
            {
            ...
            public override async void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
            {
                ...
                int drawableID = Orders.RandomOrdersDrawable;
                ...
                else
                {
                    ...
                    options.InSampleSize = Orders.CalculateInSampleSize(options, 100, 100);
